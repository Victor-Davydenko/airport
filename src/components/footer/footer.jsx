        ...
        <div className="footer__top">
          <div className="footer__column">
            <ul className="footer__list">
              ...
              <li className="footer__list-item">
                <a href="" className="footer__link">Розклад рейсів</a>
              </li>
              <li className="footer__list-item">
                <a href="" className="footer__link">Замовлення послуг</a>
              </li>
              <li className="footer__list-item">
                <a href="" className="footer__link">Контактна інформація</a>
              </li>
              <li className="footer__list-item">
                <a href="" className="footer__link">Політика конфіденційності</a>
              </li>
              <li className="footer__list-item">
                <a href="" className="footer__link">Мапа сайту</a>
              </li>
            </ul>
          </div>
          <div className="footer__column">
            <ul className="footer__list">
              ...
              <li className="footer__list-item">
                <a href="" className="footer__link">Головна</a>
              </li>
              <li className="footer__list-item">
                <a href="" className="footer__link">Наземне обслуговування</a>
              </li>
              <li className="footer__list-item">
                <a href="" className="footer__link">Характеристики аеродрому</a>
              </li>
              <li className="footer__list-item">
                <a href="" className="footer__link">Учбовий центр</a>
              </li>
              <li className="footer__list-item">
          ...
          <div className="footer__column">
            <ul className="footer__list">
              ...
              <li className="footer__list-item">
                <a href="" className="footer__link">Головна прес-центру</a>
              </li>
              <li className="footer__list-item">
                <a href="" className="footer__link">Останні новини</a>
              </li>
              <li className="footer__list-item">
                <a href="" className="footer__link">Соціальні та арт-проекти</a>
              </li>
              <li className="footer__list-item">
                <a href="" className="footer__link">Фінансова звітність</a>
              </li>
              <li className="footer__list-item">
                <a href="" className="footer__link">Статистика пасажиропотоку</a>
              </li>
            </ul>
          </div>
          <div className="footer__column">
